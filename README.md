...
- `mfcl/inputs/2023_4region`: original BET 2026 4-region MFCL input files.
- `mfcl/inputs/2023_4region_1007`: the same input with `bet.ini`
  normalized to MFCL INI version 1007 for public Kflow smoke runs.
